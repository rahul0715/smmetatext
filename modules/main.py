        ...
        for i in range(count - 1, len(links)):
            ...
            if "visionias" in url:
                async with ClientSession() as session:
                    ...
                    a = requests.get(f'https://api.classplusapp.com/cams/uploader/video/jw-signed-url?url={url}', headers={'x-access-token': 'eyJhbGciOiJIUzM4NCIsInR5cCI6IkpXVCJ9..aMMH3B852Gu9Sof4AkXfHZsxgG0v53o00SNrzagnVpQgfsw_6b4ZHvqIFQ7dSBbU'}).json()
                    r = a["url"]
                    b = requests.get(r, headers={"X-CDN-Tag": "empty"}).text
                    b_lines = b.splitlines()
                    if len(b_lines) >= 4:
                     su = b_lines[3].strip()
                     c = f"{url.replace('playlist.m3u8', '').replace('videos.classplusapp.com', 'media-cdn-alisg.classplusapp.com')}/{su}"
                     url = c
